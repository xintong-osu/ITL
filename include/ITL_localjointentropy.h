...
public:
	...
	void computeJointHistogramBinField_Scalar( int nBin )
	{
		...
		T minValue1 = ITL_util<T>::Min( this->dataField1->datastore->array, this->dataField1->grid->nVertices );
		T maxValue1 = ITL_util<T>::Max( this->dataField1->datastore->array, this->dataField1->grid->nVertices );
		T rangeValue1 = maxValue1 - minValue1;
		float binWidth1 = rangeValue1 / (float)nBin;

		T minValue2 = ITL_util<T>::Min( this->dataField2->datastore->array, this->dataField2->grid->nVertices );
		T maxValue2 = ITL_util<T>::Max( this->dataField2->datastore->array, this->dataField2->grid->nVertices );
	 ...
	 */
	void computeJointEntropyOfField( int nBins )
	{
